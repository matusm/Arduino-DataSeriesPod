/*
  ...
  This sketch simulates the continous reading of a sensor. At a predefined sample size a summary
...
unsigned long maxSamples = 100UL; // use 100 samples
...
void loop() {
  ...
  if (dsp.getSampleSize() >= maxSamples) {
    // consume parameters
    outputResult();
